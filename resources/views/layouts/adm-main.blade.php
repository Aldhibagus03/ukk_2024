...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('barang.index') }}" data-toggle="collapse" data-target="#collapseTwo"
...
<li class="nav-item dropdown no-arrow">
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
        ...
        <img class="img-profile rounded-circle"
            src="https://th.bing.com/th/id/OIP.kUFzwD5-mfBV0PfqgI5GrAHaHa?w=216&h=216&c=7&r=0&o=5&pid=1.7"
            alt="Profile Picture">
    </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Sinvent 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
